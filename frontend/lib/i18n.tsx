...
const DICTIONARY = {
  ...
  field_gestational_age: { en: 'Gestational age (weeks)', sw: 'Umri wa mimba (wiki)' },
  field_blood_pressure: { en: 'Blood pressure (sys/dia)', sw: 'Shinikizo la damu (juu/chini)' },
  field_fundal_height: { en: 'Fundal height (cm)', sw: 'Kimo cha tumbo la uzazi (cm)' },
  field_fetal_heartbeat: { en: 'Fetal heartbeat', sw: 'Mapigo ya moyo wa mtoto' },
  field_fhr_not_assessed: { en: 'Not assessed', sw: 'Haijachunguzwa' },
  field_fhr_present: { en: 'Present', sw: 'Yapo' },
  field_fhr_absent: { en: 'Absent', sw: 'Hayapo' },
  field_urine_protein: { en: 'Urine protein', sw: 'Protini kwenye mkojo' },
  field_urine_glucose: { en: 'Urine glucose', sw: 'Sukari kwenye mkojo' },
  field_urine_negative: { en: 'Negative', sw: 'Hasi' },
  field_urine_trace: { en: 'Trace', sw: 'Kiasi kidogo' },
  field_urine_positive: { en: 'Positive', sw: 'Chanya' },
  field_danger_signs: { en: 'Danger signs / complaints', sw: 'Dalili za hatari / malalamiko' },
  field_hemoglobin: { en: 'Hemoglobin (g/dL)', sw: 'Hemoglobin (g/dL)' },
  field_iron_folic_acid: { en: 'Iron-folic acid given', sw: 'Amepewa dawa za chuma-folic' },
  field_iptp_dose: { en: 'IPTp-SP dose given', sw: 'Dozi ya IPTp-SP aliyopewa' },
  field_deworming: { en: 'Deworming given', sw: 'Amepewa dawa ya minyoo' },
  field_investigations_ordered: { en: 'Investigations/tests ordered', sw: 'Vipimo vilivyoagizwa' },
